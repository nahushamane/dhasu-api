...
class Dashboard : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(menuItem: MenuItem): Boolean {
        when (menuItem.itemId) {
            ...
            R.id.nav_personal_information -> supportFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, Personal_Information()).commit()
            R.id.nav_account_settings -> supportFragmentManager.beginTransaction()
                .replace(R.id.fragment_container, Account_Settings()).commit()
            R.id.nav_signout -> {
                mAuth.signOut()
